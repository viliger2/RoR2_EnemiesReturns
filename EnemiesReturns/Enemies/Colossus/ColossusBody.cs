    ...
    public class ColossusBody : BodyBase
    {
        ...
        protected override ICharacterBody.CharacterBodyParams CharacterBodyParams(Transform aimOrigin, Sprite icon)
        {
            return new ICharacterBody.CharacterBodyParams("ENEMIES_RETURNS_COLOSSUS_BODY_NAME", GetCrosshair(), aimOrigin, icon, GetInitialBodyState())
            {
                ...
                bodyFlags = CharacterBody.BodyFlags.IgnoreFallDamage | CharacterBody.BodyFlags.IgnoreKnockup | CharacterBody.BodyFlags.Ungrabbable | CharacterBody.BodyFlags.Unmovable,
                mainRootSpeed = 7.5f,
            ...
            CharacterModel.RendererInfo[] skyMeadowRenderer = new CharacterModel.RendererInfo[]
{
        ...
        protected override ItemDisplayRuleSet ItemDisplayRuleSet()
        {
            ...
            displayRuleCollective.AddDisplayRule(new ItemDisplayRule
            {
                ...
                childName = "Head",
                localPos = new Vector3(0.03755F, 0.10504F, 0.04729F),
                localAngles = new Vector3(357.394F, 147.3612F, 2.12563F),
                localScale = new Vector3(0.33089F, 0.33089F, 0.33089F),
                limbMask = LimbFlags.None
            });
            displayRuleCollective.AddDisplayRule(new ItemDisplayRule
            {
                ...
                followerPrefabAddress = new AssetReferenceGameObject(RoR2BepInExPack.GameAssetPaths.Version_1_39_0.RoR2_DLC3_Collective.DisplayEliteCollectiveHorn_prefab),
                childName = "Head",
                localPos = new Vector3(-0.10096F, 0.10564F, 0.08435F),
                localAngles = new Vector3(3.88379F, 32.60304F, 181.3249F),
                localScale = new Vector3(-0.33089F, -0.33089F, -0.33089F),
                limbMask = LimbFlags.None
            });
            displayRuleCollective.AddDisplayRule(new ItemDisplayRule
            {
                ...
                childName = "Head",
                localPos = new Vector3(-0.03266F, 0.16963F, 0.06099F),
                localAngles = new Vector3(0F, 0F, 0F),
                localScale = new Vector3(0.2573F, 0.2573F, 0.2573F),
                limbMask = LimbFlags.None
            });
