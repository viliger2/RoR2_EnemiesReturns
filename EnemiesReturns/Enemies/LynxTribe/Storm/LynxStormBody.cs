    ...
    public class LynxStormBody : BodyBase
    {
        ...
        protected override ICharacterBody.CharacterBodyParams CharacterBodyParams(Transform aimOrigin, Sprite icon)
        {
            return new ICharacterBody.CharacterBodyParams("ENEMIES_RETURNS_LYNX_STORM_BODY_NAME", GetCrosshair(), aimOrigin, icon, GetInitialBodyState())
            {
                ...
                bodyFlags = CharacterBody.BodyFlags.IgnoreFallDamage | CharacterBody.BodyFlags.ImmuneToVoidDeath | CharacterBody.BodyFlags.IgnoreKnockup | CharacterBody.BodyFlags.ImmuneToLava
            };
        }
        ...
        protected override ItemDisplayRuleSet ItemDisplayRuleSet()
        {
            ...
            if (Items.PartyHat.PartyHatFactory.ShouldThrowParty())
            {
                ...
                displayRuleGroupPartyHat.AddDisplayRule(new ItemDisplayRule
                {
                    ...
                    localAngles = new Vector3(353.5232F, 3.66842F, 300.9822F),
