    ...
    public class IfritBody : BodyBase
    {
        ...
        protected override ItemDisplayRuleSet ItemDisplayRuleSet()
        {
            ...
            displayRuleGroupLunar.AddDisplayRule(new ItemDisplayRule
            {
                ...
                childName = "Head",
                localPos = new Vector3(-0.00056F, 0.03265F, 0.35276F),
                localAngles = new Vector3(43.26447F, 1.0525F, 0.40616F),
                localScale = new Vector3(0.67099F, 0.67099F, 0.67099F),
                limbMask = LimbFlags.None
            });
            displayRuleGroupLunar.AddDisplayRule(new ItemDisplayRule
            {
            ...
            if (Items.PartyHat.PartyHatFactory.ShouldThrowParty())
            {
                ...
                displayRuleGroupPartyHat.AddDisplayRule(new ItemDisplayRule
                {
                    ...
                    followerPrefabAddress = new UnityEngine.AddressableAssets.AssetReferenceGameObject(""),
                    childName = "Head",
                    localPos = new Vector3(-0.00359F, 0.18143F, -0.09013F),
                    localAngles = new Vector3(274.1064F, 196.056F, 162.7962F),
            ...
            displayRuleCollective.AddDisplayRule(new ItemDisplayRule
            {
                ...
                childName = "Head",
                localPos = new Vector3(0.19647F, 0.73331F, 0.38607F),
                localAngles = new Vector3(87.77569F, 29.92486F, 208.8064F),
                localScale = new Vector3(0.52213F, 0.52213F, 0.52213F),
                limbMask = LimbFlags.None
            });
            displayRuleCollective.AddDisplayRule(new ItemDisplayRule
            {
                ...
                followerPrefabAddress = new AssetReferenceGameObject(RoR2BepInExPack.GameAssetPaths.Version_1_39_0.RoR2_DLC3_Collective.DisplayEliteCollectiveHorn_prefab),
                childName = "Head",
                localPos = new Vector3(-0.24385F, 0.73915F, 0.35277F),
                localAngles = new Vector3(283.8284F, 121.3983F, 53.41693F),
                localScale = new Vector3(-0.52213F, -0.52213F, -0.52213F),
                limbMask = LimbFlags.None
            });
            displayRuleCollective.AddDisplayRule(new ItemDisplayRule
            {
                ...
                childName = "Head",
                localPos = new Vector3(-0.01523F, 0.77554F, -0.03598F),
                localAngles = new Vector3(299.5998F, 182.021F, 176.5763F),
                localScale = new Vector3(0.55915F, 0.55915F, 0.55915F),
                limbMask = LimbFlags.None
            });
