...
namespace EnemiesReturns.Behaviors
{
    public class EmissionController : MonoBehaviour
    {
        ...
        public static void ModelPanel_BuildModelInstance(RoR2.UI.ModelPanel self, GameObject newModelPrefab)
        {
            if (!self || !self.modelInstance)
            {
                return;
            }

            var components = self.modelInstance.GetComponentsInChildren<EmissionController>();
