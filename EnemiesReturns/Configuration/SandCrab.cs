...
namespace EnemiesReturns.Configuration
{
    public class SandCrab : IConfiguration
    {
        ...
        public void PopulateConfig(ConfigFile config)
        {
            ...
            BubbleBaseHealth = config.Bind("Sand Crab Fire Bubbles", "Fire Bubbles Base Health", 45f, "Sand Crab's Fire Bubbles projectile base health.");
            BubbleHealthPerLevel = config.Bind("Sand Crab Fire Bubbles", "Fire Bubbles Per Level Health", 14f, "Sand Crab's Fire Bubbles projectile per level health.");
