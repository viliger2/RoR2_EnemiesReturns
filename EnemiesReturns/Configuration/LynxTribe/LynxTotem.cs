...
namespace EnemiesReturns.Configuration.LynxTribe
{
    public class LynxTotem : IConfiguration
    {
        ...
        public void PopulateConfig(ConfigFile config)
        {
            ...
            SummonTribeSummonCountPerCast = config.Bind("Lynx Totem Summon Tribe", "Summon Tribe Summon Count Per Use", 5, "Lynx Totem's Summon Tribe number of summoned tribesmen per ability use.");
            SummonTribeMaxCount = config.Bind("Lynx Totem Summon Tribe", "Summon Tribe Summon Cap", 10, "Lynx Totem's Summon Tribe capacity. Once Totem reaches capacity it stops summoning tribesmen until at least one is dead.");
            ...
            SummonStormMaxCount = config.Bind("Lynx Totem Summon Storm", "Lynx Totem Summon Storm Max Count", 16, "Lynx Totem's Summon Storm's max count. Only works if old behavior is enabled. It summons one storm for each player, this config is for limiting number of storms for modded lobies.");
            ...
            SummonStormPullStrength = config.Bind("Lynx Totem Summon Storm", "Lynx Totem Summon Storm Pull Strength", 6f, "Lynx Totem's summoned storms pull streigth.");
            ...
            SummonStormGrabRange = config.Bind("Lynx Totem Summon Storm", "Lynx Totem Summon Storm Grab Range", 6f, "Lynx Totem's summoned storms grab range.");
            SummonStormGrabDuration = config.Bind("Lynx Totem Summon Storm", "Lynx Totem Summon Storm Grab Duration", 2f, "Lynx Totem's summoned storms grab duration. Basically for how long target stays in the air.");
            ...
            SummonStormImmunityDuration = config.Bind("Lynx Totem Summon Storm", "Lynx Totem Summon Storm Immunity Duration", 4f, "For how long players are immune to getting succed by a storm after they got throwned out by it.");
            SummonStormPoisonDuration = config.Bind("Lynx Totem Summon Storm", "Lynx Totem Summon Storm Posion Duration", 4f, "For how long posion DoT is applied. Since posion deals static damage every tick it directly affect total damage dealt.");
            SummonStormPoisonCoefficient = config.Bind("Lynx Totem Summon Storm", "Lynx Totem Summon Storm Posion Damage Coefficient", 1.25f, "Poison damage coefficient. While poison should deal % health damage, players would realistically never get enough health to overshadow initial calculation of damage off base damage, so you can use this value to adjust poison damage directly. Poison deals 33% of base damage every 0.33 seconds before this coefficient.");
            ...
            GroundpoundCooldown = config.Bind("Lynx Totem Groundpound", "Lynx Totem Groundpound Cooldown", 5f, "Lynx Totem's Groundpound's cooldown.");
            GroundpoundDamage = config.Bind("Lynx Totem Groundpound", "Lynx Totem Groundpound Damage", 3.2f, "Lynx Totem's Groundpound's damage coefficient.");
